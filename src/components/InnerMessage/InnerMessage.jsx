      ...
      <div className="flex flex-col relative  w-full h-screen md:h-full justify-end">
        <InnerHeader item={item} setIsSettingOpen={setIsSettingOpen}>
          <IoMdSettings
            ...
            className="hover:text-slate-600 hover:cursor-pointer  w-10 h-10   text-slate-400"
          />
        </InnerHeader>
        <InnerMessages />
        <MessageInput />
        ...
        <div className="chat-message">
          <div className="flex items-end">
            ...
            <img
              ...
              alt="My profile"
              className="w-10 h-10 md:w-12 md:h-12 rounded-full order-1"
            />
          </div>
        </div>
        <div className="chat-message">
          <div className="flex items-end justify-end">
            ...
            <img
              ...
              alt="My profile"
              className="w-10 h-10 md:w-12 md:h-12 rounded-full order-2"
            />
          </div>
        </div>
        <div className="chat-message">
