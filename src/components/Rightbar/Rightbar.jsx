...
function Rightbar() {
  ...
  return (
    <>
      {users ? (
        <div className="rightbar border border-r border-slate-400 bg-slate-300 dark:bg-slate-900 dark:text-white md:w-2/6 hidden lg:flex flex-col h-screen justify-center items-center min-w-fit">
