...
function LastMenuItem({ setIsOpenSubMenu }) {
  return (
    <div
      ...
      className="sidebarListItem hidden md:flex justify-center md:justify-normal md:p-1 text-gray-800 dark:text-gray-200 font-bold   rounded-2xl hover:bg-gray-400 hover:text-gray-200 w-full dark:md:hover:bg-slate-800 transition duration-150 ease-in-out cursor-pointer "
    >
