        ...
        isSidebar
          ? `${
              title === "Create" || title === "Dark/Light"
                ? "hidden md:flex"
                : "flex"
            }  justify-center font-bold  md:justify-normal md:p-3  md:w-full rounded-2xl dark:lg:hover:bg-slate-800 hover:bg-gray-400 hover:text-gray-200 transition duration-150 ease-in-out`
